        ...
        <div className="container">
          <div className="row main-row">
            ...
            <div className="col-3 contact4">
              <h3>Contact Us</h3>
              <p><i className="fa-solid fa-location-dot"></i> 123 Medical Center Dr, Healthcare City, HC 12345</p>
              <p><i className="fa-solid fa-phone"></i> 0306-4016103</p>
              <p><i className="fa-regular fa-envelope"></i> khan.college@gmail.com</p>

              {/* ✅ p ki jagah div use karo */}
          ...
          <div className="row last-row">
            <div style={{ color: "white" }} className="col-6 mt-5 end">
            ...
            <div className="col-6 text-end privacy">
              <p>
                ...
                <a style={{ textDecoration: "none" }} href="">Cookie Policy</a>
              </p>
            </div>
          </div>
        </div>
